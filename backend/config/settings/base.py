"""
Base Django settings for B2B SaaS template.
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "b2b_saas"),
...
SPECTACULAR_SETTINGS = {
    "TITLE": "B2B SaaS Template API",
    "DESCRIPTION": "Production-ready B2B SaaS template API",
    "VERSION": "1.0.0",
