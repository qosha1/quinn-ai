...
- If you report to CEO: `workers/ceo/wrkr-74817084/`
- If you report to a director: `workers/ceo/director-{id}/wrkr-74817084/`
...
```bash
# Save team process
cp our-standup-notes.md $SHARED_STORAGE/teams/Executive/

# Team standards
cat $SHARED_STORAGE/teams/Executive/coding-standards.md
```
...
2. System creates ask bead: "Offboard storage review: wrkr-74817084"
